...
* Stable release of 1.3.0 for production use
...
### Fixed
- Resource lookup regression introduced in 1.2.6-beta.1.

## [1.2.6-beta.1] - 2026-04-08

### Added
- Configuration API to set allowed document types and countries per validation.
...
### Fixed
- Audio playback during document capture.

## [1.2.2] - 2026-03-27

### Added
- Flag images for Bolivia and Ecuador.
...
### Added
- Support for Ecuador and Bolivia (countries and national ID documents).
...
### Added
- Injection detection on iOS.
- Portuguese and English document capture audio.

## [1.0.0] - 2026-03-05

First stable release of the Truora Validations SDK for production use.
...
### Added
- `surfaceVariantColor` and `onSurfaceVariantColor` parameters to `UIConfig`.

## [1.0.0-beta.4] - 2026-02-17

### Added
- `onSecondaryColor` parameter to `UIConfig`.
...
- Support for document with face validation flows.
...
### Added
- Document capture, feedback and results polling.
...
### Added
- Basic features for capture of face biometry and comparing against a prev backend account enrollment.
